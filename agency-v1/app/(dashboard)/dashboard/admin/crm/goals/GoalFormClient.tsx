                    ...
                    <div className="relative z-10 rounded-2xl p-6 w-[440px]" style={{ background: 'rgba(15,20,35,0.98)', border: '1px solid rgba(30,41,59,0.9)', boxShadow: '0 0 60px rgba(0,0,0,0.6)' }}>
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <p className="font-mono text-[11px] font-black text-slate-200 uppercase tracking-widest">Nueva Meta · {period}</p>
                            </div>
                            <button onClick={() => setOpen(false)} className="text-slate-600 hover:text-slate-300 transition-colors"><X size={16} /></button>
                        </div>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                <label className="font-mono text-[9px] text-slate-500 uppercase tracking-widest block mb-2">Vendedor (vacío = meta global)</label>
                            ...
                            <div>
                                <label className="font-mono text-[9px] text-slate-500 uppercase tracking-widest block mb-2">Etiqueta (opcional)</label>
