...
export const ROUTE_PERMISSIONS: Record<string, UserRole[]> = {
    ...
    "/dashboard/admin/payroll": [UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.CLIENT_ADMIN],
    "/dashboard/admin/payroll/employees": [UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.CLIENT_ADMIN],
    "/dashboard/admin/payroll/employees/new": [UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.CLIENT_ADMIN],
    "/dashboard/admin/payroll/expenses": [UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.CLIENT_ADMIN],
