...
import { Settings, ExternalLink, RefreshCw, Power, ShieldCheck } from "lucide-react";
...
export function IntegrationAppCard({
    ...
    const handleDisconnect = async (e: React.MouseEvent) => {
        ...
        if (!confirm("¿Estás seguro de desconectar? Se detendrá la sincronización de datos.")) return;
        ...
        try {
            ...
            toast.error("Error al desconectar. Intenta de nuevo.");
        } finally {
                ...
                <div className="p-6 flex-1 flex flex-col">
                    <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            {/* Verify button — only shown for connected integrations */}
                            {isConnected && providerId && (
                                <button
                                    onClick={() => setVerifyOpen(true)}
                                    title="Verificar conexión real"
