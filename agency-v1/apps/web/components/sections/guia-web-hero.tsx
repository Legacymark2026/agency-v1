        ...
        <div className="relative min-h-[90vh] w-full flex items-center justify-center bg-slate-950 overflow-hidden pt-24 pb-16">
            ...
            <div className="container relative z-20 px-4 md:px-6">
                <div className="flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto">
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-950/40 border border-teal-500/20 text-teal-400 text-sm font-medium mb-4">
                    ...
                    {/* Features row */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-16 w-full text-slate-400">
