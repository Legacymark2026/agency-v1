...
export function StepLaunch() {
    ...
    async function handleLaunch() {
        setIsLaunching(true);
        try {
            // 1. Save or update the campaign draft with ALL wizard data
            const { id } = await saveCampaignDraft({
                ...
                targeting: {
                    ...
                    lookalike: targeting.lookalike,
                    lookalikeSource: targeting.lookalikeSource,
                    lookalikePercentage: targeting.lookalikePercentage,
                    remarketing: targeting.remarketing,
                    remarketingSources: targeting.remarketingSources,
                    exclusionLocations: targeting.exclusionLocations,
                },
                creative: {
                    ...
                    primaryTexts: creative.primaryTexts,
                    callToAction: creative.callToAction,
                    destinationUrl: creative.destinationUrl,
                    assetUrls: creative.assetUrls,
                    adGroups: creative.adGroups,
                    abTestVariants: creative.abTestVariants,
                },
                ...
                parameters: {
                    ...
                    bidStrategy: budget.bidStrategy,
                    bidAmount: budget.bidAmount,
                    costCapAmount: budget.costCapAmount,
                    roasTarget: budget.roasTarget,
                    budgetType: budget.type,
                    pacing: budget.pacing,
                    locations: targeting.locations,
                    interests: targeting.interests,
