...
export default async function DashboardLayout({
    ...
    const allRoutes = [
        ...
        "/dashboard", "/dashboard/pos", "/dashboard/inventory", "/dashboard/sales-forecast", "/dashboard/dian", "/dashboard/security/audit-ledger", "/dashboard/invoicing", "/dashboard/invoicing/ocr-scanner", "/dashboard/invoicing/fraud-guard",
        ...
        "/dashboard/admin/crm/scoring", "/dashboard/admin/sales", "/dashboard/admin/sales/goals", "/dashboard/admin/crm/commissions",
