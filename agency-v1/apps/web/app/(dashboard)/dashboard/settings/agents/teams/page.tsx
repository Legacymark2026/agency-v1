                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                    <div>
                        <div className="flex items-center gap-3 mb-2">
                            <div className="w-10 h-10 rounded-[0.15rem] bg-purple-950/20 border border-purple-800/40 flex items-center justify-center">
                                <Users className="w-5 h-5 text-purple-400" />
                            </div>
                            <div>
                                <h1 className="text-2xl font-black tracking-tight text-[var(--ds-text-primary)]">Agent Team Studio</h1>
                    ...
                    {/* Strategy legend */}
                    <div className="flex-shrink-0 rounded-[0.15rem] border border-[var(--ds-border)] bg-[var(--ds-surface)] p-4 min-w-[220px]">
                        <p className="text-[10px] text-[var(--ds-text-muted)] uppercase tracking-widest font-bold mb-3">Estrategias de Ejecución</p>
                        <div className="space-y-2 text-[11px]">
                            {[
                                { icon: <Zap className="w-3 h-3 text-[var(--ds-teal-md)]"/>,    label: "Paralelo",   desc: "Todos al mismo tiempo" },
                                ...
                                <div key={s.label} className="flex items-center gap-2 text-[var(--ds-text-secondary)]">
                                    {s.icon}
                                    <span className="font-semibold text-[var(--ds-text-primary)]">{s.label}:</span>
                                    <span>{s.desc}</span>
                                </div>
                            ))}
                        </div>
