    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-300 pb-10">
            ...
            <section className="space-y-4">
                <h3 className="font-semibold text-[var(--ds-text-primary)] text-sm uppercase tracking-wider">Contraseña</h3>
            ...
            <section className="space-y-4">
                <h3 className="font-semibold text-[var(--ds-text-primary)] text-sm uppercase tracking-wider">Doble Autenticación</h3>
                <TwoFactorToggle initialData={securityData} />
                <BackupCodesModal initialData={securityData} />
            </section>

            <section className="space-y-4">
                <h3 className="font-semibold text-[var(--ds-text-primary)] text-sm uppercase tracking-wider">Sesiones Activas</h3>
