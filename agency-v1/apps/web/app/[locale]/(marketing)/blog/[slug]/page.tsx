...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      ...
      post.excerpt ||
      `Lee ${post.title} en nuestro blog`,
  ...
  return (
    <>
      ...
      {Array.isArray(post.faqs) && (post.faqs as any[]).length > 0 && (
        <FAQSchema
          questions={(post.faqs as any[]).map((q: any) => ({
            question: q.question,
            answer: q.answer,
          }))}
        />
      ...
      >
        ...
        >
          <div
            ...
            style={{
              width: "0%",
              background:
                "linear-gradient(90deg, #2dd4bf 0%, #38bdf8 60%, #a78bfa 100%)",
            }}
          />
        </div>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(13,148,136,0.07) 0%, transparent 100%)",
          }}
        >
          {/* Top accent line */}
        ...
        {post.coverImage && (
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 -mt-4 mb-12 relative z-10">
            <figure className="relative">
              <div
                className="aspect-[21/9] w-full relative overflow-hidden rounded-2xl group"
                style={{
                  boxShadow:
                    "0 40px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(30,41,59,0.8)",
                }}
              >
                <Image
                  src={post.coverImage}
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pb-20 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_300px] gap-12">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div
                className="hidden lg:block mt-8 pt-8"
                style={{ borderTop: "1px solid rgba(30,41,59,0.8)" }}
              >
                <EngagementBar
                  postId={post.id}
