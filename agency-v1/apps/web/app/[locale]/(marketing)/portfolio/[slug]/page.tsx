...
export default async function ProjectPage({
  ...
  const coverUrl = project.coverImage
    ? project.coverImage.replace("/uploads/", "/api/serve/")
    : null;
      ...
      <div className="relative w-full h-[65vh] min-h-[500px] flex items-end pb-16 pt-32 lg:pb-24">
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
          <Link href="/portfolio">
            <Button
              variant="ghost"
              className="mb-8 -ml-3 pl-2 text-slate-300 hover:text-white hover:bg-white/10 backdrop-blur-md rounded-full transition-all"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-3 space-y-8 sticky top-32">
            <div className="rounded-2xl border border-slate-800/80 bg-slate-900/40 p-6 backdrop-blur-xl shadow-xl">
              <h3 className="text-xs font-bold text-teal-500 uppercase tracking-widest mb-6 border-b border-slate-800 pb-4">
                Detalles del Proyecto
              </h3>
              <dl className="space-y-6 text-sm">
                <div>
                  <dt className="text-slate-500 mb-1 font-medium">
                    Cliente Oficial
                  </dt>
                  <dd className="font-semibold text-slate-200 text-base">
          ...
          <div className="lg:col-span-9">
              ...
              {project.content ? (
                ...
                <div className="text-center py-12">
                  <p className="italic text-slate-500">
                    Detalles técnicos del caso de estudio próximamente...
                  </p>
                </div>
              )}
            </div>
            ...
            {project.gallery && (project.gallery as any[]).length > 0 && (
              <div className="mb-12 flex flex-col items-center">
                <span className="text-teal-500 font-bold tracking-[0.2em] uppercase text-xs mb-3 block">
                  Dirección de Arte
                </span>
