...
dotenv_1.default.config({ path: path_1.default.resolve(__dirname, "../../../apps/web/.env.local") });
...
async function testEngine() {
    ...
    try {
        ...
        await database_1.prisma.companyUser.create({
            data: {
                companyId,
                userId: agentA.id,
            }
        ...
        const rule1 = await database_1.prisma.leadAssignmentRule.create({
            data: {
                companyId,
        ...
        const rule2 = await database_1.prisma.leadAssignmentRule.create({
            data: {
                companyId,
        ...
        const rule3 = await database_1.prisma.leadAssignmentRule.create({
            data: {
                companyId,
        ...
        const assignFB1 = await (0, assignment_engine_1.routeLead)(leadFB1);
        const assignFB2 = await (0, assignment_engine_1.routeLead)(leadFB2);
        const assignFB3 = await (0, assignment_engine_1.routeLead)(leadFB3);
        ...
        const assignDirect1 = await (0, assignment_engine_1.routeLead)(leadDirect1);
        const assignDirect2 = await (0, assignment_engine_1.routeLead)(leadDirect2);
        ...
        const assignWeb1 = await (0, assignment_engine_1.routeLead)(leadWeb1);
        const assignWeb2 = await (0, assignment_engine_1.routeLead)(leadWeb2);
        const assignWeb3 = await (0, assignment_engine_1.routeLead)(leadWeb3);
        const assignWeb4 = await (0, assignment_engine_1.routeLead)(leadWeb4);
        ...
        const assignFall1 = await (0, assignment_engine_1.routeLead)(leadFallback1);
        const assignFall2 = await (0, assignment_engine_1.routeLead)(leadFallback2);
        const assignFall3 = await (0, assignment_engine_1.routeLead)(leadFallback3);
...
testEngine();
//# sourceMappingURL=test-crm-assignment.js.map