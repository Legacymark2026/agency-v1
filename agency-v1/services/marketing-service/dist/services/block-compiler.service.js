    ...
    static async compileBlocksToHtmlWithCache(design, variablesContext) {
        ...
        if (cacheKey && redisClient) {
            try {
                ...
                if (cachedHtml) {
                    return variable_parser_service_1.VariableParserService.parseVariables(cachedHtml, variablesContext);
                }
            }
            catch { }
        }
        ...
        return variable_parser_service_1.VariableParserService.parseVariables(compiledRawHtml, variablesContext);
    }
    /**
     * Compilar un objeto EmailDesignJson a HTML responsive
     */
    static compileBlocksToHtml(design) {
        ...
        `;
            ...
            case "social": {
                ...
                const icons = (block.links || [])
                    .map((s) => `<a href="${s.url}" target="_blank" style="display: inline-block; margin: 0 6px; color: #38bdf8; text-decoration: none; font-size: 13px; font-weight: bold;">[${s.platform.toUpperCase()}]</a>`)
                    .join("");
                return `
          <div style="text-align: ${align}; margin: 20px 0;">
            ${icons}
...
exports.BlockCompilerService = BlockCompilerService;
//# sourceMappingURL=block-compiler.service.js.map