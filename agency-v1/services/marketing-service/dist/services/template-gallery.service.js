...
exports.TemplateGalleryService = void 0;
const database_1 = require("@agency/database");
class TemplateGalleryService {
    /**
     * Obtiene la lista de plantillas disponibles (sistema y personalizadas)
     */
    static async getTemplates(companyId, category) {
        let allTemplates = [...this.getSystemTemplates()];
        if (companyId) {
            try {
                const dbTemplates = await database_1.prisma.emailTemplate.findMany({
                    where: { companyId }
                });
    ...
    static async getTemplate(templateId) {
        ...
        if (sysTemplate)
            return sysTemplate;
        try {
            return await database_1.prisma.emailTemplate.findUnique({ where: { id: templateId } });
        }
        catch (err) {
     ...
     */
    static async createTemplate(companyId, data) {
        return database_1.prisma.emailTemplate.create({
            data: {
                ...data,
                companyId,
                isSystem: false
     ...
     */
    static async cloneTemplate(templateId, companyId) {
...
exports.TemplateGalleryService = TemplateGalleryService;
//# sourceMappingURL=template-gallery.service.js.map