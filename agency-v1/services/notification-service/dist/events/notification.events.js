...
exports.EVENT_MAPPINGS = void 0;
exports.subscribePlatformEvents = subscribePlatformEvents;
...
function formatHumanMessage(eventName, d) {
    if (!d)
        return "Notificación de actividad en la plataforma";
    const data = d.data || d;
    switch (eventName) {
        case "lead.created":
        ...
        default:
            if (typeof d.message === "string" && !d.message.startsWith("{"))
                return d.message;
...
function subscribePlatformEvents(eventBus) {
    for (const [eventName, mapping] of Object.entries(exports.EVENT_MAPPINGS)) {
