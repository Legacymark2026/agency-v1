...
exports.sendResilientEmail = sendResilientEmail;
const database_1 = require("@agency/database");
async function sendResilientEmail(payload) {
    let attempts = 0;
    ...
    try {
        const outboxEvent = await database_1.prisma.outboxEvent.create({
            data: {
...
//# sourceMappingURL=email-fallback-transporter.js.map