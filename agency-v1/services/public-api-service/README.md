...
This is the **public-api-service**, built as part of our microservices architecture. It uses Node.js, Express, and TypeScript.
It runs on port **4015**.

## Responsibilities & Business Domain
Public-facing API gateway for external developers.
