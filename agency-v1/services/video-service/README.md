...
This is the **video-service**, built as part of our microservices architecture. It uses Node.js, Express, and TypeScript.
It runs on port **4007**.

## Responsibilities & Business Domain
Video processing, streaming, and meeting management.
