...
export class GraphosAgent extends BaseAgent {
    constructor(config) {
     ...
     */
    async generateTextOverlays(input) {
        var _a;
        const overlays = [];
        let currentTime = 0;
        ...
        if (outroSegment) {
            const ctaOverlay = {
                ...
                startTime: outroSegment.startTime || currentTime,
                duration: 2,
                approved: false
            };
        ...
        if ((_a = input.branding) === null || _a === void 0 ? void 0 : _a.logo) {
            const lowerThird = {
     ...
     */
    validateSafeZones(overlays, platform) {
        const validations = [];
        ...
        for (const overlay of overlays) {
            ...
            const isValid = yPosition >= platformBounds.minY &&
    ...
    getFontSize(platform, type) {
        ...
        return ((_a = sizes[platform]) === null || _a === void 0 ? void 0 : _a[type]) || 24;
    }
    /**
     * Extrae el título del voiceover
     */
    extractTitle(voiceover) {
        if (!voiceover)
            return 'Título';
     ...
     */
    generateRecommendations(input, validations) {
