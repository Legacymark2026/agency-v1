...
export interface TimelineSegment {
  ...
  startTime?: number; // Tiempo de inicio del segmento
}
...
// ============================================
// TIPOS DE TEXTOS Y GRÁFICOS (GRAPHOS)
// ============================================
...
export const STYLE_PRESETS: Record<VideoStyle, {
