...
export default function HeroInteractive() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#01426F] text-white pt-24 pb-20 lg:pt-32 lg:pb-32">
      {/* 1. Ultra-high-resolution Corporate Architectural Office Background (30% more visible & vivid) */}
      <div className="absolute inset-0 z-0">
        <Image
          ...
          quality={95}
          sizes="100vw"
          className="object-cover object-center scale-105 filter brightness-[0.98] contrast-[1.02]"
        />
        {/* Cinematic dark blue enterprise tint (reduced by 30% for higher background visibility) */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#012d4d]/58 via-[#011e33]/62 to-[#030e17]/78 backdrop-blur-[0.5px]" />
        {/* Radial highlight focusing on the center (30% lighter) */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_85%_65%_at_50%_25%,rgba(1,66,111,0.38),rgba(2,12,22,0.65))] pointer-events-none" />
        {/* Subtle gold ambient glow at the top */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_40%_at_50%_-10%,rgba(176,138,26,0.22),transparent_70%)] pointer-events-none" />
        {/* Fine technical grid lines */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(176,138,26,0.04)_1px,transparent_1px),linear-gradient(to_bottom,rgba(176,138,26,0.04)_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_70%_60%_at_50%_35%,#000_70%,transparent_100%)] pointer-events-none" />
      </div>
