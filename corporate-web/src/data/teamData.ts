...
export const corporateValues: CorporateValue[] = [
  {
    ...
    subtitle: "Velocidad con criterio estratégico",
    description: "Respondemos a la volatilidad del mercado con metodologías ágiles que acortan el ciclo de decisión sin comprometer el rigor metodológico.",
    gradient: "from-blue-950 to-slate-900",
  },
  {
    id: "precision",
    title: "Precisión e Integridad",
    subtitle: "Rigor analítico y ética inquebrantable",
    description: "Cada diagnóstico y recomendación se sustenta en evidencia empírica, análisis cuantitativo profundo y el más estricto secreto profesional.",
    gradient: "from-slate-900 to-amber-950/40",
  },
  {
    id: "innovacion",
    title: "Innovación Sostenible",
    subtitle: "Vanguardia tecnológica aplicable",
    description: "Implementamos inteligencia artificial, automatización y arquitecturas cloud que generan valor comercial tangible y perdurable.",
    gradient: "from-blue-900/80 to-slate-950",
  },
  {
    id: "resultados",
    title: "Impacto Cuantificable",
    subtitle: "Enfoque obsesivo en el ROI",
    description: "No nos medimos por horas facturadas sino por el incremento del margen operativo, la reducción de riesgos y la satisfacción del cliente.",
