                ...
                <div className="flex gap-2 w-full justify-between sm:justify-end">
                    ...
                    {isConnected ? (
                        <>
                            ...
                            {onDisconnect && (
                                <Button variant="ghost" size="sm" onClick={onDisconnect} className="h-8 text-slate-400 hover:text-red-400 hover:bg-red-500/10 hover:border-red-500/20 border border-transparent">
