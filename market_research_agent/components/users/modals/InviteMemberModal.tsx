            ...
            <div className="relative w-full max-w-sm p-6 overflow-hidden"
                ...
                <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p className="font-mono text-[9px] text-slate-500 uppercase tracking-widest">Enviar acceso por correo</p>
                    </div>
                </div>

                <div className="mb-6 space-y-4">
                    <div>
                        <label className="block font-mono text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Correo Electrónico</label>
                        <input 
                            type="email" 
                            value={inviteEmail}
                            onChange={(e) => setInviteEmail(e.target.value)}
                            placeholder="ejemplo@agencia.com"
                            className="w-full px-3 py-2 font-mono text-[11px] text-slate-200 placeholder:text-slate-600 rounded-sm transition-all focus:outline-none"
                            style={{ background: 'rgba(15,23,42,0.5)', border: '1px solid rgba(30,41,59,0.8)' }}
                        />
                    </div>
                    <div>
                        <label className="block font-mono text-[9px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Nivel de Acceso</label>
                        <select 
                            value={inviteRole}
                            onChange={(e) => setInviteRole(e.target.value)}
                            className="w-full px-3 py-2 font-mono text-[11px] text-slate-200 rounded-sm transition-all focus:outline-none appearance-none"
                            style={{ background: 'rgba(15,23,42,0.5)', border: '1px solid rgba(30,41,59,0.8)' }}
                        >
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        disabled={isInviting}
                        className="flex-1 flex items-center justify-center gap-2 py-2.5 font-mono text-[9px] font-bold uppercase tracking-widest text-teal-400 hover:text-teal-300 transition-all rounded-sm disabled:opacity-40"
